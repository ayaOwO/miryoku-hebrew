...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_HEBREW)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_HEBREW_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_HEBREW)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_HEBREW
    #elif defined (MIRYOKU_ALPHAS_QWERTZ)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_HEBREW)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HEBREW_FLIP
    ...
    #elif defined (MIRYOKU_EXTRA_HEBREW)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_HEBREW
    #elif defined (MIRYOKU_EXTRA_QWERTZ)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_HEBREW)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_HEBREW_FLIP
    ...
    #elif defined (MIRYOKU_TAP_HEBREW)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_HEBREW
    #elif defined (MIRYOKU_TAP_QWERTZ)
